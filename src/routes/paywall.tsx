...
const GOAL_LABELS: Record<string, { label: string; short: string }> = {
  ...
  hybrid: { label: "Treino Híbrido", short: "Performance Híbrida" },
      ...
      <div className="relative z-10 mx-auto max-w-sm px-5 pb-14 pt-8">
          ...
          <div className="rounded-3xl p-5" style={{ background: "rgba(9,14,24,0.95)" }}>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {[
                ...
                { label: "Equipamentos", value: equipCount > 0 ? `${equipCount} ${equipCount === 1 ? "item" : "itens"}` : "Peso corporal" },
              ].map((item) => (
        ...
        <div className="mt-6 flex justify-center">
          <ShareVideoButton
            ...
            title="Compartilhar 3D Body Scanner"
