      ...
      {showSummary && (
        <WorkoutCompleteAnimation
          ...
          onFinish={() => {
            ...
            navigate({ to: "/app/historico/$id", params: { id: workout.id } });
          }}
        />
      )}
    <div className="space-y-5 pb-6">
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-border bg-gradient-surface p-4 shadow-elevated sm:p-5">
        ...
        <div className="relative">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <ShareVideoButton
                ...
                title={c.shareWorkout ?? "Compartilhar treino"}
                variant="ghost"
              />
            </div>
          </div>
          ...
          {/* Preview do vídeo do treino com botão Play */}
          <div className="mt-4 flex items-center gap-4 rounded-2xl border p-4" style={{ borderColor: "rgba(34,211,238,0.2)", background: "rgba(34,211,238,0.04)" }}>
            ...
            <div className="min-w-0 flex-1">
              <div className="text-sm font-bold text-foreground">Compartilhe seu treino</div>
              <div className="mt-0.5 text-xs text-muted-foreground">Story pronto para Instagram e WhatsApp com seus stats reais</div>
              <div className="mt-2 text-[10px] font-semibold uppercase tracking-widest" style={{ color: "#22d3ee" }}>Formato 9:16 · 13 seg</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        ...
        <div className="rounded-3xl border border-border bg-surface p-4">
          ...
          <h3 className="mt-1 font-display text-lg font-semibold">{c.proDir}</h3>
          <p className="mt-2 text-sm text-muted-foreground">
        ...
        <div className="rounded-3xl border border-border bg-surface p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <h3 className="mt-1 font-display text-lg font-semibold">{c.sessionMetrics}</h3>
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <MetricCard label={c.sets} value={`${totalSets}`} />
            <MetricCard label={c.reps} value={`${totalReps}`} />
            <MetricCard label={c.type} value={formatDisplayValue(workout.type, "type")} />
          </div>
        </div>
              ...
              <div className="h-12 w-12 relative">
                <svg className="h-12 w-12 -rotate-90" viewBox="0 0 36 36">
                  ...
                  <circle
                    ...
                    strokeWidth="3"
                    strokeDasharray={`${(restTimer.remaining / restTimer.total) * 100} 100`}
                    strokeLinecap="round"
                  />
                </svg>
              </div>
