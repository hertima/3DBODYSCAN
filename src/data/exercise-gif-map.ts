...
export const exerciseGifMap: ExerciseGifMap = {
  ...
  "elevacao-lateral": "ElevaÇõÇœo lateral 01 (1).mp4",
  "elevacao-cabos": "ElevaÇõÇœo lateral no cabo (1).mp4",
  ...
  panturrilha: "Panturrilha em pÇ¸ mÇ­quina (1).mp4",
  ...
  "leg-raise": "ElevaÇõÇœo de pernas solo (1).mp4",
