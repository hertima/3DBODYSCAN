...
const curatedExercises: Exercise[] = [
  {
    ...
    muscle: "Peito",
    equipment: "Barra",
    biomechanics: "Empurrar horizontal",
    instructions: [
      "Deite no banco com os pés firmes no chão",
      "Pegada um pouco mais aberta que os ombros",
      "Desça a barra controlado até o peito",
      "Empurre explosivo mantendo escápulas retraídas",
    ],
    mistakes: ["Arquear lombar excessivamente", "Cotovelos abertos 90°", "Saltar barra do peito"],
    alternatives: ["supino-halter", "flexao"],
  },
  {
    id: "supino-halter",
    ...
    equipment: "Banco",
    biomechanics: "Empurrar horizontal",
    instructions: ["Halteres na altura do peito", "Empurre em arco até quase tocar"],
    mistakes: ["Travar cotovelos", "Pouca amplitude"],
  ...
  },
  {
    ...
    muscle: "Peito",
    equipment: "Halteres",
    biomechanics: "Adução horizontal",
    instructions: ["Cotovelos levemente flexionados", "Abra controlado e feche contraindo o peito"],
    mistakes: ["Descer demais e perder tensão"],
  ...
  },
  {
    ...
    equipment: "Cabos",
    biomechanics: "Adução horizontal",
    instructions: ["Inclinação leve à frente", "Puxe cruzando à frente"],
    mistakes: ["Usar peso demais"],
...

  {
    ...
    muscle: "Costas",
    equipment: "Barra",
    biomechanics: "Puxar horizontal",
    instructions: ["Tronco a 45°", "Puxe a barra ao umbigo", "Aperte escápulas"],
    mistakes: ["Tronco subindo a cada repetição"],
    alternatives: ["remada-baixa", "remada-australiana"],
  },
  {
    id: "remada-baixa",
    name: "Remada Baixa",
    ...
    equipment: "Cabos",
    biomechanics: "Puxar horizontal",
    instructions: ["Coluna neutra", "Puxe ao abdômen"],
  ...
  },
  {
    ...
    muscle: "Costas",
    equipment: "Cabos",
    biomechanics: "Puxar vertical",
    instructions: ["Pegada pronada larga", "Puxe ao peito alto"],
    mistakes: ["Inclinar demais"],
  ...
  },
  {
    ...
    biomechanics: "Puxar vertical",
    instructions: ["Suba até queixo passar a barra", "Desça controlado total"],
    mistakes: ["Balanço com pernas"],
    alternatives: ["puxada-frente"],
  },

  {
    ...
    muscle: "Ombros",
    equipment: "Barra",
    biomechanics: "Empurrar vertical",
    instructions: ["Barra na altura do queixo", "Empurre acima da cabeça"],
    mistakes: ["Arquear lombar"],
    alternatives: ["desenvolvimento-halter"],
  },
  {
    ...
    equipment: "Halteres",
    biomechanics: "Empurrar vertical",
    instructions: ["Halteres na altura dos ombros", "Suba em arco"],
    mistakes: ["Tocar halteres no topo bruscamente"],
  ...
  },
  {
    ...
    muscle: "Ombros",
    equipment: "Halteres",
    biomechanics: "Abdução",
    instructions: ["Cotovelos levemente flexionados", "Suba até linha do ombro"],
    mistakes: ["Usar trapézio"],
    alternatives: ["elevacao-cabos"],
  },
  {
    id: "elevacao-cabos",
    ...
    equipment: "Cabos",
    biomechanics: "Abdução",
    instructions: ["Cabo cruza pelo corpo"],
    mistakes: ["Inclinar tronco"],
    alternatives: ["elevacao-lateral"],
  },

  {
    ...
    muscle: "Bíceps",
    equipment: "Barra",
    biomechanics: "Flexão de cotovelo",
    instructions: ["Cotovelos colados ao tronco", "Suba contraindo bíceps"],
    mistakes: ["Balanço de tronco"],
  ...
  },
  {
    ...
    equipment: "Halteres",
    biomechanics: "Flexão de cotovelo",
    instructions: ["Supinação no meio do movimento"],
  ...
  },
  {
    ...
    muscle: "Bíceps",
    equipment: "Halteres",
    biomechanics: "Flexão neutra",
    instructions: ["Pegada neutra", "Trabalha braquial"],
    mistakes: ["Usar inércia"],
    alternatives: ["rosca-alternada"],
  },

  {
    ...
    muscle: "Tríceps",
    equipment: "Cabos",
    biomechanics: "Extensão",
    instructions: ["Cotovelos fixos", "Abra a corda no final"],
    mistakes: ["Mover cotovelo"],
    alternatives: ["triceps-frances"],
  },
  {
    id: "triceps-frances",
    ...
    equipment: "Halteres",
    biomechanics: "Extensão",
    instructions: ["Cotovelos apontando ao teto", "Desça atrás da cabeça"],
    mistakes: ["Abrir cotovelos"],
    alternatives: ["triceps-corda"],
  },
  {
    id: "mergulho",
    ...
    equipment: "Paralelas",
    biomechanics: "Empurrar vertical",
    instructions: ["Tronco vertical para tríceps", "Desça até 90°"],
    mistakes: ["Cabeça caindo à  frente"],
    alternatives: ["triceps-corda"],
  },

  {
    ...
    muscle: "Pernas",
    equipment: "Barra",
    biomechanics: "Agachamento",
    instructions: ["Barra apoiada no trapézio", "Desça até paralelo", "Suba empurrando o chão"],
    mistakes: ["Joelhos colapsando para dentro", "Lombar arredondada"],
    alternatives: ["leg-press", "agachamento-pc"],
  },
  {
    id: "leg-press",
    name: "Leg Press 45°",
    ...
    muscle: "Pernas",
    equipment: "Máquina",
    biomechanics: "Empurrar pernas",
    instructions: ["Pés na largura dos ombros", "Desça até 90°"],
    mistakes: ["Tirar quadril do banco"],
  ...
  },
  {
    ...
    muscle: "Pernas",
    equipment: "Barra",
    biomechanics: "Hip hinge",
    instructions: ["Pernas semi-flexionadas", "Desça com coluna neutra"],
    mistakes: ["Arredondar lombar"],
    alternatives: ["levantamento-terra"],
  },
  {
    ...
    equipment: "Barra",
    biomechanics: "Hip hinge",
    instructions: ["Barra junto ao corpo", "Empurre o chão"],
    mistakes: ["Subir com lombar"],
    alternatives: ["stiff"],
  },
  {
    ...
    muscle: "Pernas",
    equipment: "Máquina",
    biomechanics: "Extensão joelho",
    instructions: ["Contração total no topo"],
    mistakes: ["Parar muito no topo"],
    alternatives: ["agachamento"],
  },
  {
    id: "mesa-flexora",
    ...
    muscle: "Pernas",
    equipment: "Máquina",
    biomechanics: "Flexão joelho",
    instructions: ["Quadril fixo no banco"],
    mistakes: ["Usar quadril"],
    alternatives: ["stiff"],
  },
  {
    id: "panturrilha",
...

  {
    ...
    muscle: "Glúteos",
    equipment: "Barra",
    biomechanics: "Hip thrust",
    instructions: ["Apoio escapular no banco", "Empurre quadril ao teto"],
    mistakes: ["Hiperextender lombar"],
    alternatives: ["agachamento"],
  },
  {
    id: "abdutor",
    ...
    muscle: "Glúteos",
    equipment: "Máquina",
    biomechanics: "Abdução quadril",
    instructions: ["Tronco levemente à frente"],
    mistakes: ["Balançar"],
    alternatives: [],
  },
  {
    id: "panturrilha-pc",
    name: "Panturrilha em Pé (Peso Corporal)",
    type: "Calistenia",
    muscle: "Pernas",
    equipment: "Peso corporal",
    biomechanics: "Flexão plantar",
    instructions: [
      "Fique na ponta dos pés na borda de um degrau ou plano",
      "Suba ao máximo e desça abaixo do nível do calcanhar",
      "Controle em 2s de descida",
    ],
    mistakes: ["Amplitude curta", "Usar impulso"],
    alternatives: ["panturrilha-halter"],
  },
  {
    ...
    biomechanics: "Flexão plantar",
    instructions: [
      "Segure haltere em uma mão, apoie a outra na parede",
      "Suba na ponta do pé fazendo movimento completo",
    ],
    mistakes: ["Amplitude curta", "Velocidade alta"],
    alternatives: ["panturrilha-pc"],
  },

  {
    ...
    muscle: "Core",
    equipment: "Peso corporal",
    biomechanics: "Anti-extensão",
    instructions: ["Linha reta corpo", "Glúteos contraídos"],
    mistakes: ["Quadril alto demais"],
    alternatives: ["abdominal"],
  },
  {
    id: "abdominal",
    ...
    muscle: "Core",
    equipment: "Peso corporal",
    biomechanics: "Flexão tronco",
    instructions: ["Eleve apenas escápulas"],
  ...
  },
  {
    ...
    muscle: "Core",
    equipment: "Barra fixa",
    biomechanics: "Flexão quadril",
    instructions: ["Pernas estendidas até 90°"],
    mistakes: ["Balanço"],
    alternatives: ["abdominal"],
  },
  {
    ...
    equipment: "Peso corporal",
    biomechanics: "Anti-extensão",
    instructions: ["Avance sem arquear lombar"],
    mistakes: ["Arquear lombar"],
    alternatives: ["prancha"],
  },

  {
    ...
    equipment: "Peso corporal",
    biomechanics: "Empurrar horizontal",
    instructions: ["Corpo alinhado", "Desça até peito quase tocar o chão"],
    mistakes: ["Quadril caindo"],
    alternatives: ["supino-halter"],
  },
  {
    id: "flexao-fechada",
    name: "Flexão Fechada",
    ...
    muscle: "Tríceps",
    equipment: "Peso corporal",
    biomechanics: "Extensão cotovelo",
    instructions: ["Mãos próximas abaixo do peito", "Cotovelos colados ao tronco na subida"],
    mistakes: ["Abrir cotovelos", "Quadril caindo"],
    alternatives: ["triceps-corda", "mergulho"],
  },
  {
    id: "dips-cadeira",
    ...
    biomechanics: "Extensão cotovelo",
    instructions: [
      "Apoio nas mãos atrás do corpo",
      "Desça até cotovelos a 90°",
      "Empurre subindo sem travar",
    ],
    mistakes: ["Ombros subindo", "Amplitude curta"],
    alternatives: ["mergulho", "flexao-fechada"],
  },
  {
    id: "remada-australiana",
    ...
    biomechanics: "Puxar horizontal",
    instructions: [
      "Corpo inclinado sob a barra, calcanhar no chão",
      "Puxe o peito até a barra mantendo escápulas retraídas",
      "Desça controlado",
    ],
    mistakes: ["Quadril caindo", "Usar impulso"],
    alternatives: ["remada-curvada", "barra-fixa"],
  },
  {
    id: "superman",
    name: "Superman",
    ...
    instructions: [
      ...
      "Eleve peito e pernas simultaneamente contraindo as costas",
      "Segure 2s no topo e desça controlado",
    ],
    mistakes: ["Usar impulso", "Pescoço tenso"],
    alternatives: ["remada-australiana"],
  },
  {
    id: "curl-barra-fixa",
    ...
    biomechanics: "Flexão de cotovelo",
    instructions: [
      "Pegada supinada na barra",
      "Puxe concentrando a contração no bíceps",
      "Cotovelso na frente do corpo",
    ],
    mistakes: ["Balanço corporal", "Usar as costas"],
    alternatives: ["rosca-direta", "remada-australiana"],
  },
  {
    id: "elevacao-toalha",
    name: "Elevação Lateral com Toalha",
    type: "Calistenia",
    muscle: "Ombros",
    equipment: "Parede",
    biomechanics: "Abdução",
    instructions: [
      "Toalha presa na parede ou porta",
      "Incline o corpo e eleve lateralmente com resistência",
      "Controle a descida",
    ],
    mistakes: ["Usar trapézio", "Movimento rápido"],
    alternatives: ["elevacao-lateral", "handstand"],
  },
  {
    id: "pike-push-up",
    name: "Pike Push-up",
    ...
    biomechanics: "Empurrar vertical",
    instructions: [
      "Quadril elevado formando V invertido",
      "Desça a cabeça entre as mãos",
      "Empurre subindo sem abrir o quadril",
    ],
    mistakes: ["Quadril caindo", "Cotovelos muito abertos"],
    alternatives: ["handstand", "desenvolvimento"],
  },
  {
    id: "agachamento-pc",
    ...
    mistakes: ["Joelhos colapsando para dentro", "Levantar calcanhares"],
    alternatives: ["agachamento-bulgaro-pc", "pistol-squat"],
  },
  {
    id: "afundo-pc",
    ...
    muscle: "Pernas",
    equipment: "Peso corporal",
    biomechanics: "Agachamento unilateral",
    instructions: [
      "Dê um passo largo à frente",
      "Desça o joelho traseiro próximo ao chão",
      "Suba e alterne as pernas",
    ],
    mistakes: ["Tronco muito inclinado", "Joelho ultrapassar o pé"],
    alternatives: ["agachamento-bulgaro-pc", "pistol-squat"],
  },
  {
    id: "agachamento-bulgaro-pc",
    ...
    biomechanics: "Agachamento unilateral",
    instructions: [
      "Pé traseiro elevado num banco ou degrau",
      "Desça o joelho traseiro próximo ao chão",
      "Suba empurrando com o calcanhar da frente",
    ],
    mistakes: ["Joelho ultrapassar muito o pé", "Tronco muito inclinado"],
    alternatives: ["pistol-squat", "afundo-pc"],
  },
  {
    id: "hip-thrust-solo",
    name: "Hip Thrust no Solo",
    type: "Calistenia",
    muscle: "Glúteos",
    equipment: "Peso corporal",
    biomechanics: "Hip thrust",
    instructions: [
      "Deite com joelhos dobrados e pés no chão",
      "Eleve o quadril contraindo glúteos no topo",
      "Segure 2s no pico e desça controlado",
    ],
    mistakes: ["Hiperextender lombar", "Usar impulso"],
    alternatives: ["elevacao-quadril", "agachamento-bulgaro-pc"],
  },
  {
    id: "ponte-gluteos-unilateral",
    ...
    biomechanics: "Hip thrust",
    instructions: [
      "Deite com uma perna estendida",
      "Eleve o quadril empurrando com o calcanhar da perna apoiada",
      "Contraia glúteos no topo e desça controlado",
    ],
    mistakes: ["Usar impulso", "Quadril torto"],
    alternatives: ["hip-thrust-solo", "elevacao-quadril"],
  },
  {
    id: "muscle-up",
    name: "Muscle Up",
    ...
    muscle: "Costas",
    equipment: "Barra fixa",
    biomechanics: "Puxar + Empurrar",
    instructions: ["Explosão na transição"],
    mistakes: ["Falta de puxada alta"],
    alternatives: ["barra-fixa"],
  },
  {
    id: "pistol-squat",
    ...
    equipment: "Peso corporal",
    biomechanics: "Agachamento unilateral",
    instructions: ["Equilíbrio em uma perna"],
    mistakes: ["Calcanhar levantando"],
    alternatives: ["agachamento-bulgaro-pc"],
  },
  {
    id: "handstand",
    ...
    muscle: "Ombros",
    equipment: "Parede",
    biomechanics: "Empurrar vertical invertido",
    instructions: ["Cabeça toca o chão controlado"],
    mistakes: ["Hiperextender lombar"],
    alternatives: ["pike-push-up"],
  },
  {
    id: "front-lever",
    name: "Front Lever",
    ...
    muscle: "Core",
    equipment: "Barra fixa",
    biomechanics: "Isometria",
    instructions: ["Corpo paralelo ao chão"],
    mistakes: ["Quadril caindo"],
    alternatives: ["leg-raise"],
  },
];
...
export const workouts: Workout[] = [
  {
    ...
    exercises: [
      ...
      {
        exerciseId: "desenvolvimento-halter",
        sets: [
          { reps: 10, weight: 22 },
          { reps: 10, weight: 22 },
          { reps: 8, weight: 24 },
...
const shouldersMuscle = curatedExercises.find(
  (exercise) => exercise.id === "desenvolvimento",
)!.muscle;
...
const glutesMuscle = curatedExercises.find(
  (exercise) => exercise.id === "elevacao-quadril",
)!.muscle;
...
// Nomes que contêm uma palavra-chave genérica de equipamento leve/peso corporal
// (ex: "flexao", "abdominal", "paralela") mas na prática exigem um aparelho de
// academia — sem essa checagem, caíam no fallback errado (peso corporal ou
// paralelas portáteis) e apareciam em treinos de casa sem o equipamento real.
const equipmentAnchorOverrides = [
  { match: "nordica", equipment: "Maquina" },
  { match: "abdominal declinado", equipment: "Banco" },
  { match: "abs banco declinado", equipment: "Banco" },
  ...
  { match: "bench tricep dips", equipment: "Banco" },
  { match: "dips na cadeira", equipment: "Peso corporal" },
] as const;

const coreOverrides = ["declinado smith"] as const;

const corePathOverrides = ["PEITORAL (1)/DECLINADO SMITH"] as const;
...
const catalogOverrides = [
  ...
  {
    match: "remada alta com halteres",
    muscle: backMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  ...
  {
    match: "agachamento pes afastados",
    muscle: legsMuscle,
    type: strengthType,
    equipment: "Barra",
  },
  {
    match: "agachamento sumo peso corporal",
    muscle: legsMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  ...
  {
    match: "aducao deitada unilateral",
    muscle: legsMuscle,
    type: strengthType,
    equipment: "Maquina",
  },
  ...
  {
    match: "flexora em pe unilateral",
    muscle: legsMuscle,
    type: strengthType,
    equipment: "Maquina",
  },
  ...
  {
    match: "pulley pegada aberta atras da nuca",
    muscle: backMuscle,
    type: strengthType,
    equipment: "Cabos",
  },
  {
    match: "pulley pegada aberta pronada",
    muscle: backMuscle,
    type: strengthType,
    equipment: "Cabos",
  },
  {
    match: "crucifixo polia baixa",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Cabos",
  },
  {
    match: "crucifixo invertido polia baixa",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Cabos",
  },
  {
    match: "crucifixo inverto com halteres",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  {
    match: "crucifixo invertido com halter",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  {
    match: "crucifixo invertido na maquina",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Maquina",
  },
  ...
  {
    match: "elevacao lateral com halters",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  {
    match: "elevacao do cotovelo unilateral",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  ...
  {
    match: "arnold dips maschine",
    muscle: tricepsMuscle,
    type: strengthType,
    equipment: "Maquina",
  },
  {
    match: "triceps coice com halteres",
    muscle: tricepsMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  ...
  {
    match: "frontal lateral invertido",
    muscle: shouldersMuscle,
    type: strengthType,
    equipment: "Halteres",
  },
  ...
  {
    match: "reverse hyperextension",
    muscle: glutesMuscle,
    type: strengthType,
    equipment: "Maquina",
  },
  {
    match: "extensao no elastico",
    muscle: glutesMuscle,
    type: strengthType,
    equipment: "Elastico",
  },
  {
    match: "flex de joelho em pe no cabo cross",
    muscle: backMuscle,
...
function inferTypeFromCatalog(path: string): ExerciseType {
  ...
  const isExplicitBodyweight = explicitBodyweightKeywords.some(
...
function inferBiomechanicsFromCatalog(muscle: MuscleGroup, type: ExerciseType, exerciseName = "") {
  ...
  if (muscle === "Peito") {
    if (
      n.includes("crucifixo") ||
      n.includes("voador") ||
      n.includes("fly") ||
      n.includes("crossover") ||
      n.includes("cross")
    )
      return "Adução horizontal";
  ...
  if (muscle === legsMuscle || muscle === glutesMuscle) {
    ...
    if (n.includes("flexora") || n.includes("mesa flex") || n.includes("leg curl"))
      return "Isolamento posterior";
    if (
      n.includes("hip thrust") ||
      n.includes("pelvica") ||
      n.includes("ponte") ||
      (n.includes("extensao") && (n.includes("quadril") || n.includes("apoio")))
    )
      return "Hip thrust";
    if (
      n.includes("stiff") ||
    ...
    if (n.includes("agachamento") || n.includes("squat") || n.includes("goblet"))
      return "Agachamento";
    if (
      n.includes("afundo") ||
      n.includes("avanco") ||
      ...
      return "Afundo";
    if (n.includes("panturrilha") || n.includes("gemeos") || n.includes("calf"))
      return "Panturrilha";
...
function getAutoInstructions(biomechanics: string): string[] {
  ...
  if (b.includes("empurrar horizontal") || b.includes("press horizontal"))
    return [
      "Posicione-se com o equipamento na altura do peito e escápulas retraídas",
      "Empurre em linha reta ou em arco controlado até quase a extensão dos cotovelos",
      "Desça de forma lenta e controlada sentindo o alongamento muscular",
      "Mantenha o core ativado e o corpo estável durante todo o movimento",
    ];
  if (b.includes("puxar horizontal") || b.includes("remada"))
    return [
      "Posicione o tronco inclinado ou sentado com coluna neutra",
      "Puxe o peso em direção ao abdômen retraindo as escápulas",
      "Segure 1s na contração máxima antes de soltar",
      "Retorne controlado até a extensão completa dos braços",
    ];
  if (b.includes("puxar vertical") || b.includes("puxada"))
    return [
      "Posicione-se com os braços estendidos acima segurando a carga",
      "Deprime as escápulas antes de iniciar o movimento",
      "Puxe os cotovelos para baixo e para trás trazendo a carga ao peito",
      "Retorne controlado até a extensão completa sem perder a tensão",
    ];
  if (b.includes("empurrar vertical") || b.includes("desenvolvimento") || b.includes("overhead"))
    return [
      "Posicione a carga na altura dos ombros com core ativado e lombar neutra",
      "Empurre verticalmente acima da cabeça sem travar os cotovelos no topo",
      "Desça de forma controlada de volta à altura dos ombros",
      "Mantenha o abdômen contraído para proteger a lombar durante todo o movimento",
    ];
  if (b.includes("agachamento") || b.includes("squat"))
    return [
      "Pés na largura dos ombros com pontas levemente abertas",
      "Inicie empurrando os joelhos na direção dos dedos dos pés",
      "Desça mantendo o peito alto e a lombar neutra até a profundidade adequada",
      "Suba empurrando com os calcanhares contraindo glúteos e quadríceps",
    ];
  if (b.includes("hip hinge") || b.includes("terra") || b.includes("stiff"))
    return [
      "Fique em pé com coluna neutra e core pré-ativado",
      "Inicie o movimento empurrando o quadril para trás — não curve a lombar",
      "Desça mantendo a coluna neutra até sentir o alongamento do posterior de coxa",
      "Suba empurrando o quadril à frente e contraindo glúteos",
    ];
  if (b.includes("hip thrust") || b.includes("glúteo"))
    return [
      "Apoie as escápulas no banco e posicione os pés no chão",
      "Contraia os glúteos e empurre o quadril verticalmente para cima",
      "Segure 2s no topo com quadril, joelhos e ombros em linha reta",
      "Desça controlado sem encostar o quadril completamente antes de repetir",
    ];
  if (b.includes("abdução") || b.includes("abducao"))
    return [
      "Posicione-se com o equipamento e cotovelos levemente flexionados",
      "Abra o braço ou a perna lateralmente de forma controlada até a amplitude máxima",
      "Segure 1s no ponto de abertura máxima contraindo o músculo alvo",
      "Retorne de forma lenta e controlada mantendo a tensão",
    ];
  if (
    b.includes("adução") ||
    b.includes("aducao") ||
    b.includes("crossover") ||
    b.includes("crucifixo")
  )
    return [
      "Posicione-se com os braços abertos e cotovelos levemente flexionados",
      "Feche os braços em arco contraindo o músculo alvo no centro",
      "Segure 1s na contração máxima",
      "Retorne controlado ao ponto de alongamento sem perder o controle",
    ];
  if (b.includes("flexão de cotovelo") || b.includes("rosca") || b.includes("curl"))
    return [
      "Segure a carga com cotovelos fixos ao lado do tronco",
      "Suba contraindo conscientemente o músculo alvo",
      "Segure 1s no topo com contração máxima",
      "Desça de forma totalmente controlada até a extensão completa",
    ];
  if (b.includes("extensão") || b.includes("triceps") || b.includes("extension"))
    return [
      "Posicione-se com cotovelos fixos apontando para o teto ou à frente",
      "Estenda o cotovelo contraindo o tríceps completamente",
      "Segure 1s na extensão máxima",
      "Retorne controlado até o ponto de máximo alongamento do tríceps",
    ];
  if (b.includes("flexão plantar") || b.includes("panturrilha") || b.includes("calf"))
    return [
      "Posicione a meia planta do pé na borda da superfície de apoio",
      "Desça os calcanhares abaixo do nível para o máximo alongamento",
      "Suba na ponta dos pés o mais alto possível contraindo a panturrilha",
      "Segure 2s no topo e desça de forma muito controlada (3s)",
    ];
  if (b.includes("anti-extensão") || b.includes("isometria") || b.includes("prancha"))
    return [
      "Posicione-se com o corpo em linha reta da cabeça aos calcanhares",
      "Ative glúteos, abdômen e quadríceps simultaneamente",
      "Mantenha a respiração constante — não prenda o ar",
      "Segure o tempo máximo mantendo todas as compensações sob controle",
    ];
  if (b.includes("flexão tronco") || b.includes("abdominal") || b.includes("crunch"))
    return [
      "Deite com joelhos dobrados e pés apoiados no chão",
      "Contraia o abdômen e eleve apenas as escápulas — não o tronco inteiro",
      "Expire completamente na contração máxima",
      "Desça controlado sem apoiar completamente antes da próxima rep",
    ];
  return [
...
function getAutoMistakes(biomechanics: string): string[] {
  ...
  if (b.includes("empurrar horizontal"))
    return [
      "Arquear a lombar excessivamente para empurrar mais peso",
      "Cotovelos completamente abertos a 90° sobrecarregando os ombros",
      "Descer sem controle usando apenas a gravidade",
    ];
  if (b.includes("puxar"))
    return [
      "Usar impulso do tronco em vez de ativar os músculos das costas",
      "Não retrair as escápulas no ponto de contração máxima",
      "Encurtar a amplitude sem completar a extensão dos braços",
    ];
  if (b.includes("empurrar vertical") || b.includes("overhead"))
    return [
      "Arquear a lombar para compensar falta de mobilidade de ombro",
      "Travar os cotovelos no topo eliminando tensão no deltóide",
      "Inclinar demais o tronco transferindo carga para o peitoral",
    ];
  if (b.includes("agachamento") || b.includes("squat"))
    return [
      "Joelhos colapsando para dentro ao subir — indica fraqueza de glúteo médio",
      "Lombar arredondada no fundo do movimento",
      "Calcanhares se levantando do chão durante a execução",
    ];
  if (b.includes("hip hinge"))
    return [
      "Arredondar a lombar durante o movimento — principal causa de lesão",
      "Dobrar os joelhos em excesso transformando em agachamento",
      "Descer a carga longe do corpo criando alavanca prejudicial",
    ];
  if (b.includes("flexão de cotovelo") || b.includes("curl"))
    return [
      "Balançar o tronco usando impulso em vez de força muscular",
      "Não completar a amplitude — nem subir nem descer totalmente",
      "Cotovelos se afastando do tronco durante a execução",
    ];
  if (b.includes("extensão") || b.includes("triceps"))
    return [
      "Mover os cotovelos durante o movimento — devem permanecer fixos",
      "Usar impulso para completar as repetições em vez de força do tríceps",
      "Amplitude reduzida que não trabalha o músculo completamente",
    ];
  if (b.includes("flexão plantar") || b.includes("panturrilha"))
    return [
      "Amplitude curta sem descer ao alongamento máximo",
      "Usar impulso do joelho em vez de força da panturrilha",
      "Velocidade alta que desperdiça a fase excêntrica fundamental",
    ];
  return [
...
export const libraryExercises: Exercise[] = [...curatedExercises, ...catalogExercises].sort(
  compareLibraryExercises,
);
