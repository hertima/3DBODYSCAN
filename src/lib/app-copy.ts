...
const appCopy = {
  ...
  en: {
    ...
    dashboard: { todayWorkout: "Today's workout", weeklyTitle: "Your 3D Body Scanner week", coachLabel: "AI Coach", profileTitle: "Progress profile", achievementsTitle: "Achievements", achievementsOpen: "Unlocked achievements", greeting: "Hello,", headline: "Ready to evolve?", startBtn: "Start", exercisesLabel: "exercises", weekLabel: "Week", statSeries: "Weekly sets", statFrequency: "Frequency", statWorkouts: "Workouts in plan", statReadiness: "Readiness", statDays: "days", statAchievements: "achievements", levelLabel: "Current level", xpLabel: "XP earned", streakLabel: "Streak", streakDays: "days", streakDesc: "Consistency based on training and hydration", dailyMission: "Daily mission", weekRhythm: "Weekly rhythm", setsPlanned: "sets planned", viewAll: "View all", aiTitle: "AI Recommendations", sessionPlanned: "session planned by AI", sessionsPlanned: "sessions planned by AI" },
