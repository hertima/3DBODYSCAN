...
const nutritionCopy = {
  pt: {
    tag: "Nutrição", title: "Plano Alimentar", regenerate: "Regenerar",
    ...
    generateBtn: "Gerar Plano com IA", generating: "Gerando plano...",
    generatingHint: "Isso pode levar até 30 segundos...",
    weekLabel: "Semana", weekOf: "de 12 semanas", generatedAt: "Gerado em",
    ...
    kcalPerDay: "kcal/dia", twelveWeeks: "12 semanas", cardDesc: "Gere seu plano personalizado de 12 semanas",
  ...
  es: {
    tag: "Nutrición", title: "Plan Alimentario", regenerate: "Regenerar",
    ...
    generateBtn: "Generar Plan con IA", generating: "Generando plan...",
    generatingHint: "Esto puede tardar hasta 30 segundos...",
    weekLabel: "Semana", weekOf: "de 12 semanas", generatedAt: "Generado el",
    ...
    kcalPerDay: "kcal/día", twelveWeeks: "12 semanas", cardDesc: "Genera tu plan alimentario personalizado de 12 semanas",
  ...
  en: {
    tag: "Nutrition", title: "Meal Plan", regenerate: "Regenerate",
    emptyTitle: "AI Meal Plan",
    emptyDesc: "Generate your personalized 12-week meal plan based on your profile and goal.",
    generateBtn: "Generate Plan with AI", generating: "Generating plan...",
    generatingHint: "This may take up to 30 seconds...",
    weekLabel: "Week", weekOf: "of 12 weeks", generatedAt: "Generated on",
    ...
    kcalPerDay: "kcal/day", twelveWeeks: "12 weeks", cardDesc: "Generate your personalized 12-week meal plan",
  ...
  fr: {
    tag: "Nutrition", title: "Plan Alimentaire", regenerate: "Régénérer",
    ...
    generateBtn: "Générer le Plan avec l'IA", generating: "Génération en cours...",
    generatingHint: "Cela peut prendre jusqu'à 30 secondes...",
    weekLabel: "Semaine", weekOf: "de 12 semaines", generatedAt: "Généré le",
    ...
    kcalPerDay: "kcal/jour", twelveWeeks: "12 semaines", cardDesc: "Générez votre plan alimentaire personnalisé de 12 semaines",
  ...
  de: {
    tag: "Ernährung", title: "Ernährungsplan", regenerate: "Neu generieren",
    ...
    generateBtn: "Plan mit KI erstellen", generating: "Plan wird erstellt...",
    generatingHint: "Dies kann bis zu 30 Sekunden dauern...",
    weekLabel: "Woche", weekOf: "von 12 Wochen", generatedAt: "Erstellt am",
    ...
    kcalPerDay: "kcal/Tag", twelveWeeks: "12 Wochen", cardDesc: "Erstelle deinen personalisierten 12-Wochen-Ernährungsplan",
...
export function getGamificationCopy(locale: AppLocale = getStoredLocale()): GamificationCopy {
  return (gamificationCopy as unknown as Record<string, GamificationCopy>)[locale] ?? gamificationCopy.pt;
}
...
export function getRecommendationsCopy(locale: AppLocale = getStoredLocale()): RecommendationsCopy {
  return (recommendationsCopy as unknown as Record<string, RecommendationsCopy>)[locale] ?? recommendationsCopy.pt;
}

const perfilCopy = {
  pt: {
    shareBtn: "Compartilhar perfil", levelLabel: "Nível", streakLabel: "Streak", xpLabel: "XP",
    settingsBtn: "Configurações", signOutBtn: "Sair da conta", redoOnboarding: "Refazer onboarding",
    aiInsightLabel: "Leitura da IA:", aiInsightText: "seu perfil está calibrado para {focus}, com janela ideal de {duration}, consistência {consistency} e divisão {split}.",
    blueprintTitle: "Blueprint do atleta", blueprintSubtitle: "Motor de personalização", activePlanBadge: "Plano ativo",
    missionsTitle: "Missões premium", missionsSubtitle: "Jornada diária → anual", adherenceLabel: "aderência",
    muscleFocusLabel: "Foco muscular", activeSplitLabel: "Divisão ativa", workoutsPerWeek: "treinos / semana", daysPerWeekSuffix: "dias/sem", uniqueModelsSuffix: "modelos",
    scheduleDays: ["Seg", "Ter", "Qua", "Qui", "Sex", "Sáb", "Dom"], restDayLabel: "Descanso",
    notApplicable: "Não se aplica", notProvided: "Não informado", cycleActiveUnknown: "Ativo | fase não informada", cycleNotActive: "Não ativado",
    equipmentSelected: "itens selecionados", equipmentNone: "Sem restrição informada",
    attrGoal: "Objetivo", attrModality: "Modalidade", attrSplit: "Divisão", attrFrequency: "Frequência",
    attrDuration: "Duração", attrEnvironment: "Ambiente", attrBioProfile: "Perfil bio.", attrGym: "Academia", attrCycle: "Ciclo",
    goalLabels: { ganho_massa: "Ganho de Massa", perda_peso: "Perda de Peso", definicao: "Definição", forca: "Força", performance: "Performance", saude: "Saúde" },
    ...
    gymSizeLabels: { pequena: "Academia Pequena", media: "Academia Média", grande: "Academia Grande" },
    ...
    cycleLabels: { menstrual: "Menstrual | intensidade leve", follicular: "Folicular | progressão", ovulatory: "Ovulatória | pico controlado", luteal: "Lútea | recuperação protegida" },
    windowLabels: { diaria: "Diária", semanal: "Semanal", mensal: "Mensal", trimestral: "Trimestral", semestral: "Semestral", anual: "Anual" },
  },
  es: {
    shareBtn: "Compartir perfil", levelLabel: "Nivel", streakLabel: "Streak", xpLabel: "XP",
    settingsBtn: "Configuración", signOutBtn: "Cerrar sesión", redoOnboarding: "Repetir onboarding",
    aiInsightLabel: "Lectura de IA:", aiInsightText: "tu perfil está calibrado para {focus}, con ventana ideal de {duration}, consistencia {consistency} y división {split}.",
    blueprintTitle: "Perfil del atleta", blueprintSubtitle: "Motor de personalización", activePlanBadge: "Plan activo",
    missionsTitle: "Misiones premium", missionsSubtitle: "Jornada diaria → anual", adherenceLabel: "adherencia",
    muscleFocusLabel: "Foco muscular", activeSplitLabel: "División activa", workoutsPerWeek: "entrenos / semana", daysPerWeekSuffix: "días/sem", uniqueModelsSuffix: "modelos",
    scheduleDays: ["Lun", "Mar", "Mié", "Jue", "Vie", "Sáb", "Dom"], restDayLabel: "Descanso",
    notApplicable: "N/A", notProvided: "No informado", cycleActiveUnknown: "Activo | fase no informada", cycleNotActive: "No activado",
    equipmentSelected: "elementos seleccionados", equipmentNone: "Sin restricción informada",
    attrGoal: "Objetivo", attrModality: "Modalidad", attrSplit: "División", attrFrequency: "Frecuencia",
    attrDuration: "Duración", attrEnvironment: "Entorno", attrBioProfile: "Perfil bio.", attrGym: "Gimnasio", attrCycle: "Ciclo",
    goalLabels: { ganho_massa: "Ganancia Muscular", perda_peso: "Pérdida de Peso", definicao: "Definición", forca: "Fuerza", performance: "Rendimiento", saude: "Salud" },
    levelLabels: { iniciante: "Principiante", intermediario: "Intermedio", avancado: "Avanzado" },
    locationLabels: { academia: "Gimnasio", casa: "Casa", hibrido: "Híbrido", outdoor: "Aire libre" },
    consistencyLabels: { ocasional: "Ocasional", regular: "Regular", elite: "Élite" },
    gymSizeLabels: { pequena: "Gimnasio Pequeño", media: "Gimnasio Mediano", grande: "Gimnasio Grande" },
    crowdLabels: { vazio: "Horario vacío", normal: "Horario normal", pico: "Hora pico" },
    sexLabels: { feminino: "Femenino", masculino: "Masculino" },
    cycleLabels: { menstrual: "Menstrual | intensidad leve", follicular: "Folicular | progresión", ovulatory: "Ovulatoria | pico controlado", luteal: "Lútea | recuperación protegida" },
    windowLabels: { diaria: "Diaria", semanal: "Semanal", mensal: "Mensual", trimestral: "Trimestral", semestral: "Semestral", anual: "Anual" },
  },
  en: {
    shareBtn: "Share profile", levelLabel: "Level", streakLabel: "Streak", xpLabel: "XP",
    settingsBtn: "Settings", signOutBtn: "Sign out", redoOnboarding: "Redo onboarding",
    aiInsightLabel: "AI reading:", aiInsightText: "your profile is calibrated for {focus}, with an ideal window of {duration}, {consistency} consistency and {split} split.",
    blueprintTitle: "Athlete blueprint", blueprintSubtitle: "Personalization engine", activePlanBadge: "Active plan",
    missionsTitle: "Premium missions", missionsSubtitle: "Daily → annual journey", adherenceLabel: "adherence",
    muscleFocusLabel: "Muscle focus", activeSplitLabel: "Active split", workoutsPerWeek: "workouts / week", daysPerWeekSuffix: "days/wk", uniqueModelsSuffix: "models",
    scheduleDays: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], restDayLabel: "Rest",
    notApplicable: "N/A", notProvided: "Not provided", cycleActiveUnknown: "Active | phase unknown", cycleNotActive: "Not active",
    equipmentSelected: "items selected", equipmentNone: "No restriction given",
    attrGoal: "Goal", attrModality: "Modality", attrSplit: "Split", attrFrequency: "Frequency",
    attrDuration: "Duration", attrEnvironment: "Environment", attrBioProfile: "Bio profile", attrGym: "Gym", attrCycle: "Cycle",
    goalLabels: { ganho_massa: "Muscle Gain", perda_peso: "Weight Loss", definicao: "Definition", forca: "Strength", performance: "Performance", saude: "Health" },
    ...
    cycleLabels: { menstrual: "Menstrual | light intensity", follicular: "Follicular | progression", ovulatory: "Ovulatory | controlled peak", luteal: "Luteal | protected recovery" },
    windowLabels: { diaria: "Daily", semanal: "Weekly", mensal: "Monthly", trimestral: "Quarterly", semestral: "Semi-annual", anual: "Annual" },
  },
  fr: {
    shareBtn: "Partager le profil", levelLabel: "Niveau", streakLabel: "Streak", xpLabel: "XP",
    settingsBtn: "Paramètres", signOutBtn: "Se déconnecter", redoOnboarding: "Refaire l'onboarding",
    aiInsightLabel: "Lecture IA :", aiInsightText: "votre profil est calibré pour {focus}, avec une fenêtre idéale de {duration}, une constance {consistency} et une division {split}.",
    blueprintTitle: "Profil de l'athlète", blueprintSubtitle: "Moteur de personnalisation", activePlanBadge: "Plan actif",
    missionsTitle: "Missions premium", missionsSubtitle: "Parcours quotidien → annuel", adherenceLabel: "adhérence",
    muscleFocusLabel: "Focus musculaire", activeSplitLabel: "Division active", workoutsPerWeek: "entraînements / semaine", daysPerWeekSuffix: "jours/sem", uniqueModelsSuffix: "modèles",
    scheduleDays: ["Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Dim"], restDayLabel: "Repos",
    notApplicable: "N/A", notProvided: "Non renseigné", cycleActiveUnknown: "Actif | phase inconnue", cycleNotActive: "Non activé",
    equipmentSelected: "éléments sélectionnés", equipmentNone: "Aucune restriction renseignée",
    attrGoal: "Objectif", attrModality: "Modalité", attrSplit: "Division", attrFrequency: "Fréquence",
    attrDuration: "Durée", attrEnvironment: "Environnement", attrBioProfile: "Profil bio.", attrGym: "Salle", attrCycle: "Cycle",
    goalLabels: { ganho_massa: "Prise de Masse", perda_peso: "Perte de Poids", definicao: "Définition", forca: "Force", performance: "Performance", saude: "Santé" },
    ...
    cycleLabels: { menstrual: "Menstruel | intensité légère", follicular: "Folliculaire | progression", ovulatory: "Ovulatoire | pic contrôlé", luteal: "Lutéale | récupération protégée" },
    windowLabels: { diaria: "Quotidien", semanal: "Hebdomadaire", mensal: "Mensuel", trimestral: "Trimestriel", semestral: "Semestriel", anual: "Annuel" },
  },
  de: {
    shareBtn: "Profil teilen", levelLabel: "Level", streakLabel: "Streak", xpLabel: "XP",
    settingsBtn: "Einstellungen", signOutBtn: "Abmelden", redoOnboarding: "Onboarding wiederholen",
    aiInsightLabel: "KI-Analyse:", aiInsightText: "dein Profil ist kalibriert für {focus}, mit einem idealen Zeitfenster von {duration}, Konstanz {consistency} und Aufteilung {split}.",
    blueprintTitle: "Athletenprofil", blueprintSubtitle: "Personalisierungsmotor", activePlanBadge: "Aktiver Plan",
    missionsTitle: "Premium-Missionen", missionsSubtitle: "Täglich → jährliche Reise", adherenceLabel: "Adhärenz",
    muscleFocusLabel: "Muskelfokus", activeSplitLabel: "Aktive Aufteilung", workoutsPerWeek: "Trainings / Woche", daysPerWeekSuffix: "Tage/Wo", uniqueModelsSuffix: "Modelle",
    scheduleDays: ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"], restDayLabel: "Pause",
    notApplicable: "N/A", notProvided: "Nicht angegeben", cycleActiveUnknown: "Aktiv | Phase unbekannt", cycleNotActive: "Nicht aktiviert",
    equipmentSelected: "Elemente ausgewählt", equipmentNone: "Keine Einschränkung angegeben",
    attrGoal: "Ziel", attrModality: "Modalität", attrSplit: "Aufteilung", attrFrequency: "Frequenz",
    attrDuration: "Dauer", attrEnvironment: "Umgebung", attrBioProfile: "Biol. Profil", attrGym: "Studio", attrCycle: "Zyklus",
    goalLabels: { ganho_massa: "Muskelaufbau", perda_peso: "Gewichtsabnahme", definicao: "Definition", forca: "Kraft", performance: "Leistung", saude: "Gesundheit" },
    levelLabels: { iniciante: "Anfänger", intermediario: "Fortgeschritten", avancado: "Sehr erfahren" },
    locationLabels: { academia: "Fitnessstudio", casa: "Zuhause", hibrido: "Hybrid", outdoor: "Outdoor" },
    consistencyLabels: { ocasional: "Gelegentlich", regular: "Regelmäßig", elite: "Elite" },
    gymSizeLabels: { pequena: "Kleines Studio", media: "Mittleres Studio", grande: "Großes Studio" },
    crowdLabels: { vazio: "Stoßzeitfrei", normal: "Normale Zeit", pico: "Stoßzeit" },
    sexLabels: { feminino: "Weiblich", masculino: "Männlich" },
    cycleLabels: { menstrual: "Menstrual | leichte Intensität", follicular: "Follikulär | Progression", ovulatory: "Ovulatorisch | kontrollierter Höhepunkt", luteal: "Luteal | geschützte Erholung" },
    windowLabels: { diaria: "Täglich", semanal: "Wöchentlich", mensal: "Monatlich", trimestral: "Vierteljährlich", semestral: "Halbjährlich", anual: "Jährlich" },
  },
} as const;
...
const historicoCopy = {
  pt: {
    backToAnalytics: "Voltar para Analytics", back: "Voltar",
    labelDuration: "Duração", labelSets: "Séries", labelVolume: "Volume", labelCalories: "Calorias",
    completedAll: "Treino 100% concluído!", setsLabel: "séries", bodyweight: "Corporal",
    ...
    prSingular: "Personal Record", prPlural: "Personal Records", prInWorkout: "neste treino", shareSession: "Compartilhar sessão",
  },
  es: {
    backToAnalytics: "Volver a Analytics", back: "Volver",
    labelDuration: "Duración", labelSets: "Series", labelVolume: "Volumen", labelCalories: "Calorías",
    completedAll: "¡Entrenamiento 100% completado!", setsLabel: "series", bodyweight: "Corporal",
    ...
    prSingular: "Récord Personal", prPlural: "Récords Personales", prInWorkout: "en este entrenamiento", shareSession: "Compartir sesión",
  },
  en: {
    backToAnalytics: "Back to Analytics", back: "Back",
    labelDuration: "Duration", labelSets: "Sets", labelVolume: "Volume", labelCalories: "Calories",
    completedAll: "Workout 100% complete!", setsLabel: "sets", bodyweight: "Bodyweight",
    ...
    prSingular: "Personal Record", prPlural: "Personal Records", prInWorkout: "in this workout", shareSession: "Share session",
  },
  fr: {
    backToAnalytics: "Retour à Analytics", back: "Retour",
    labelDuration: "Durée", labelSets: "Séries", labelVolume: "Volume", labelCalories: "Calories",
    completedAll: "Entraînement 100% complété !", setsLabel: "séries", bodyweight: "Poids du corps",
    emptyTitle: "Aucun entraînement enregistré",
    emptyDesc: "Complétez un entraînement et il apparaîtra ici avec toutes les séries et métriques.",
    goToWorkouts: "Aller aux entraînements",
    prSingular: "Record Personnel", prPlural: "Records Personnels", prInWorkout: "dans cet entraînement", shareSession: "Partager la séance",
  },
  de: {
    backToAnalytics: "Zurück zu Analytics", back: "Zurück",
    labelDuration: "Dauer", labelSets: "Sätze", labelVolume: "Volumen", labelCalories: "Kalorien",
    completedAll: "Training 100% abgeschlossen!", setsLabel: "Sätze", bodyweight: "Körpergewicht",
    ...
    prSingular: "Persönlicher Rekord", prPlural: "Persönliche Rekorde", prInWorkout: "in diesem Training", shareSession: "Einheit teilen",
  },
} as const;
