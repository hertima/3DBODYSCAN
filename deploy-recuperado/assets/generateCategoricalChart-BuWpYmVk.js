import { a4 as commonjsGlobal, R as getDefaultExportFromCjs, r as reactExports, V as React } from "./server-C0e4gypg.js";
...
var hasClipDot = function hasClipDot2(dot) {
  return dot && _typeof$A(dot) === "object" && "clipDot" in dot;
};
  ...
  return _createClass$e(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        var className = clsx(_defineProperty$x(_defineProperty$x({
...
_defineProperty$x(DefaultLegendContent, "displayName", "Legend");
_defineProperty$x(DefaultLegendContent, "defaultProps", {
  iconSize: 14,
  layout: "horizontal",
  align: "center",
  verticalAlign: "middle",
...
var Legend = /* @__PURE__ */ (function(_PureComponent) {
  function Legend2() {
    ...
    _defineProperty$w(_this, "lastBoundingBox", {
      width: -1,
      height: -1
    });
    return _this;
...
var _defineProperty$v;
var hasRequired_defineProperty;
function require_defineProperty() {
  if (hasRequired_defineProperty) return _defineProperty$v;
  ...
  _defineProperty$v = defineProperty;
  return _defineProperty$v;
}
...
function getTooltipCSSClassName(_ref) {
  ...
  return clsx(CSS_CLASS_PREFIX, _defineProperty$t(_defineProperty$t(_defineProperty$t(_defineProperty$t({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var TooltipBoundingBox = /* @__PURE__ */ (function(_PureComponent) {
  function TooltipBoundingBox2() {
    ...
    _defineProperty$s(_this, "handleKeyDown", function(event) {
      if (event.key === "Escape") {
...
_defineProperty$r(Tooltip, "displayName", "Tooltip");
_defineProperty$r(Tooltip, "defaultProps", {
...
export {
  ...
  require_baseExtremum as W,
  require_baseGt as X,
  require_baseIteratee as Y,
  require_baseLt as Z,
  getTickClassName as _,
  interpolateNumber$2 as a,
  findPositionOfBar as a0,
  getBaseValueOfBar as a1,
  Cell as a2,
  truncateByDomain as a3,
  getCateCoordinateOfBar as a4,
  getTooltipItem as a5,
  isEqual as b,
  LabelList as c,
  isNil as d,
  useChartHeight as e,
