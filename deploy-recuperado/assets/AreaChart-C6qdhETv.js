...
import { r as reactExports, V as React } from "./server-C0e4gypg.js";
import { z as throttle, w as warn, F as isPercent, H as getDisplayName, I as getAngledRectangleWidth, j as isNumber, G as Global, J as getStringSize, K as mathSign, i as isFunction, M as Text, N as shallowEqual, f as filterProps, O as get, L as Layer, P as adaptEventsOfChild, Q as Label, R as max, C as Curve, A as Animate, a as interpolateNumber, d as isNil, S as isNan, b as isEqual, r as hasClipDot, c as LabelList, s as uniqueId, g as getValueByDataKey, t as getCateCoordinateOfLine, D as Dot, u as useChartWidth, e as useChartHeight, U as useXAxisOrThrow, o as getTicksOfAxis, V as useYAxisOrThrow, v as generateCategoricalChart, x as formatAxisMap } from "./generateCategoricalChart-BuWpYmVk.js";
  ...
  var chartContent = reactExports.useMemo(function() {
    ...
    return React.Children.map(children, function(child) {
      if (/* @__PURE__ */ React.isValidElement(child)) {
        return /* @__PURE__ */ reactExports.cloneElement(child, _objectSpread$3({
