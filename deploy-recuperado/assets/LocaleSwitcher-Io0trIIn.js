...
import { c as createLucideIcon, J as reactDomExports, K as ReactDOM, S as SUPPORTED_LOCALES, M as detectBrowserLocale } from "./router-BDD3RgVy.js";
import { u as useCallbackRef$1, a as useComposedRefs, P as Primitive, c as composeEventHandlers, d as dispatchDiscreteCustomEvent, b as useLayoutEffect2, e as createContextScope, f as composeRefs, g as useDirection, h as Presence, i as createRovingFocusGroupScope, j as createCollection, I as Item, R as Root$1, k as useControllableState, l as useId } from "./index-meb4Aqgc.js";
...
function FlagBadge({ src, alt }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-4 w-6 overflow-hidden rounded-[4px] border border-white/10 shadow-sm sm:h-5 sm:w-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt, className: "h-full w-full object-cover", loading: "lazy" }) });
}
function LocaleSwitcher({ value, onChange, compact = false, align = "end" }) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: cn(
          ...
          compact ? "min-w-[142px] px-2.5 py-1.5 text-[11px] sm:min-w-[176px] sm:px-3 sm:py-2 sm:text-xs" : "min-w-[220px] sm:min-w-[240px]"
        ),
        "aria-label": "Trocar idioma",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FlagBadge, { src: activeLocale.flagSrc, alt: activeLocale.nativeLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden text-[10px] uppercase tracking-[0.16em] text-muted-foreground sm:block", children: "Idioma" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block truncate text-[12px] font-semibold text-foreground sm:text-sm", children: activeLocale.nativeLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3.5 w-3.5 text-muted-foreground sm:h-4 sm:w-4" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { align, className: "w-[300px] rounded-2xl border-border bg-surface p-2 text-foreground shadow-2xl", children: SUPPORTED_LOCALES.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        DropdownMenuItem,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FlagBadge, { src: item.flagSrc, alt: item.nativeLabel }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block truncate text-sm font-semibold", children: item.nativeLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[11px] uppercase tracking-[0.18em] text-muted-foreground", children: item.countryLabel })
            ] }),
            detected ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-cyan/10 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-cyan", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3 w-3" }),
              " Auto"
            ] }) : null,
            selected ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 text-primary" }) : null
          ]
        },
        item.code
      );
